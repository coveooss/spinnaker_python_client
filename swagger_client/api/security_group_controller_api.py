...
class SecurityGroupControllerApi(object):
    ...
    def get_security_group_using_get1(self, account, region, name, **kwargs):  # noqa: E501
        """Retrieve a security group's details  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_security_group_using_get1(account, region, name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_security_group_using_get1_with_http_info(account, region, name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_security_group_using_get1_with_http_info(account, region, name, **kwargs)  # noqa: E501
            return data

    def get_security_group_using_get1_with_http_info(self, account, region, name, **kwargs):  # noqa: E501
        """Retrieve a security group's details  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_security_group_using_get1_with_http_info(account, region, name, async_req=True)
        >>> result = thread.get()
