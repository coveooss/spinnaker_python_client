...
from spinnaker-python-client.api.subnet_controller_api import SubnetControllerApi  # noqa: E501
...
class TestSubnetControllerApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = spinnaker-python-client.api.subnet_controller_api.SubnetControllerApi()  # noqa: E501
