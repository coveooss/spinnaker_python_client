...
from spinnaker-python-client.api.version_controller_api import VersionControllerApi  # noqa: E501
...
class TestVersionControllerApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = spinnaker-python-client.api.version_controller_api.VersionControllerApi()  # noqa: E501
