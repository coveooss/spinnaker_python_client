...
from spinnaker-python-client.api.webhook_controller_api import WebhookControllerApi  # noqa: E501
...
class TestWebhookControllerApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = spinnaker-python-client.api.webhook_controller_api.WebhookControllerApi()  # noqa: E501
