...
from spinnaker-python-client.api.artifact_controller_api import ArtifactControllerApi  # noqa: E501
...
class TestArtifactControllerApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = spinnaker-python-client.api.artifact_controller_api.ArtifactControllerApi()  # noqa: E501
    ...
    def test_get_artifact_using_get(self):
        """Test case for get_artifact_using_get
