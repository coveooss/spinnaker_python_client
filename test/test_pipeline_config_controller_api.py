...
from spinnaker-python-client.api.pipeline_config_controller_api import PipelineConfigControllerApi  # noqa: E501
...
class TestPipelineConfigControllerApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = spinnaker-python-client.api.pipeline_config_controller_api.PipelineConfigControllerApi()  # noqa: E501
