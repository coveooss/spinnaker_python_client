...
class EcsServerGroupEventsControllerApi(object):
    ...
    def get_events_using_get(self, account, application, provider, region, server_group_name, **kwargs):  # noqa: E501
        """Retrieves a list of events for a server group  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_events_using_get(account, application, provider, region, server_group_name, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_events_using_get_with_http_info(account, application, provider, region, server_group_name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_events_using_get_with_http_info(account, application, provider, region, server_group_name, **kwargs)  # noqa: E501
            return data

    def get_events_using_get_with_http_info(self, account, application, provider, region, server_group_name, **kwargs):  # noqa: E501
        """Retrieves a list of events for a server group  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_events_using_get_with_http_info(account, application, provider, region, server_group_name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['account', 'application', 'provider', 'region', 'server_group_name']  # noqa: E501
