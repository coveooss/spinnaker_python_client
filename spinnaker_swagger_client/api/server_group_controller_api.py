...
class ServerGroupControllerApi(object):
    ...
    def get_server_group_details_using_get(self, account, application_name, region, server_group_name, **kwargs):  # noqa: E501
        """Retrieve a server group's details  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_group_details_using_get(account, application_name, region, server_group_name, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_server_group_details_using_get_with_http_info(account, application_name, region, server_group_name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_server_group_details_using_get_with_http_info(account, application_name, region, server_group_name, **kwargs)  # noqa: E501
            return data

    def get_server_group_details_using_get_with_http_info(self, account, application_name, region, server_group_name, **kwargs):  # noqa: E501
        """Retrieve a server group's details  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_group_details_using_get_with_http_info(account, application_name, region, server_group_name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['account', 'application_name', 'region', 'server_group_name', 'x_rate_limit_app', 'include_details']  # noqa: E501
    ...
    def get_server_groups_for_application_using_get_with_http_info(self, application_name, **kwargs):  # noqa: E501
        ...
        all_params = ['application_name', 'x_rate_limit_app', 'cloud_provider', 'clusters', 'expand']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
