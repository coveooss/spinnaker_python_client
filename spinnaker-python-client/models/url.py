...
class URL(object):
    ...
    swagger_types = {
        ...
        'content': 'object',
        'default_port': 'int',
        'deserialized_fields': 'URLStreamHandler',
        'file': 'str',
        'host': 'str',
        'path': 'str',
        'port': 'int',
    ...
    attribute_map = {
        ...
        'deserialized_fields': 'deserializedFields',
        'file': 'file',
        'host': 'host',
        'path': 'path',
        'port': 'port',
        ...
        'query': 'query',
        'ref': 'ref',
        'serialized_hash_code': 'serializedHashCode',
        'user_info': 'userInfo'
    }

    def __init__(self, authority=None, content=None, default_port=None, deserialized_fields=None, file=None, host=None, path=None, port=None, protocol=None, query=None, ref=None, serialized_hash_code=None, user_info=None):  # noqa: E501
        """URL - a model defined in Swagger"""  # noqa: E501

        self._authority = None
        self._content = None
        self._default_port = None
        self._deserialized_fields = None
        self._file = None
        self._host = None
        self._path = None
        self._port = None
        ...
        self._query = None
        self._ref = None
        self._serialized_hash_code = None
        ...
        if deserialized_fields is not None:
            self.deserialized_fields = deserialized_fields
        if file is not None:
            self.file = file
        if host is not None:
            self.host = host
        ...
        if ref is not None:
            self.ref = ref
        if serialized_hash_code is not None:
            self.serialized_hash_code = serialized_hash_code
    ...
    @property
    def deserialized_fields(self):
        """Gets the deserialized_fields of this URL.  # noqa: E501


        :return: The deserialized_fields of this URL.  # noqa: E501
        :rtype: URLStreamHandler
        """
        return self._deserialized_fields

    @deserialized_fields.setter
    def deserialized_fields(self, deserialized_fields):
        """Sets the deserialized_fields of this URL.


        :param deserialized_fields: The deserialized_fields of this URL.  # noqa: E501
        :type: URLStreamHandler
        """

        self._deserialized_fields = deserialized_fields
    ...
    @property
    def serialized_hash_code(self):
        """Gets the serialized_hash_code of this URL.  # noqa: E501


        :return: The serialized_hash_code of this URL.  # noqa: E501
        :rtype: int
        """
        return self._serialized_hash_code

    @serialized_hash_code.setter
    def serialized_hash_code(self, serialized_hash_code):
        """Sets the serialized_hash_code of this URL.


        :param serialized_hash_code: The serialized_hash_code of this URL.  # noqa: E501
        :type: int
        """

        self._serialized_hash_code = serialized_hash_code
